...
gauche** (`aquameasure-pyside/src/backend/measure_service.py` →
...
Convention de répertoire (identique à `aquameasure-pyside/src/util/paths.py`) :
...
# Le dépôt : fish-vision/src/annodb/rectify.py -> racine du dépôt.
...
class CalibrationProfile:
    ...
    def stereo_rmse(self) -> Optional[float]:
        ...
        `aquameasure-pyside/src/util/paths.py::stereo_rmse_if_exists` - relu ici
        pour que `fish-vision` reste utilisable sans l'application Qt.
        """
