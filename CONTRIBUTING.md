...
Ne pas ajouter de vidéos de terrain, bases de session, jetons d’accès, poids IA ou exécutables. Les captures de documentation peuvent utiliser des exemples de démonstration clairement identifiés.
